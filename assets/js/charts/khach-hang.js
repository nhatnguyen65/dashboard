// Plugins dùng chung (giống trang Đơn hàng)
const glowPlugin = {
    id: "glow",
...
new Chart(document.getElementById("chart-cust-segmentation"), {
    ...
    data: {
        ...
        datasets: [
            {
                data: [22, 58, 12, 8],
                backgroundColor: ["#6c757d", "#28a745", "#dc3545", "#17a2b8"],
                borderWidth: 3,
                borderColor: "#FFF",
        ...
        datasets: [
            {
                label: "Lượt truy cập",
                data: [
                    120, 150, 180, 210, 260, 300, 330, 320, 300, 360, 390, 420,
                ],
                borderColor: "#007bff",
            ...
            {
                label: "Thêm giỏ",
                data: [40, 55, 60, 70, 90, 100, 115, 110, 100, 130, 145, 160],
                borderColor: "#ffc107",
